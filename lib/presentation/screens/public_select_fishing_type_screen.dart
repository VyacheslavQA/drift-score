...
import 'public_competitions_list_screen.dart';

class PublicSelectFishingTypeScreen extends StatelessWidget {
  const PublicSelectFishingTypeScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text('Выбор типа рыбалки', style: AppTextStyles.h2),
        ...
        child: InkWell(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (_) => PublicCompetitionsListScreen(fishingType: type),
              ),
            );
          },
          borderRadius: BorderRadius.circular(AppDimensions.radiusLarge),
  ...
  Widget _buildCastingCard(BuildContext context) {
    const Color castingColor = Color(0xFFD35400);
        ...
        child: InkWell(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (_) => PublicCompetitionsListScreen(fishingType: 'casting'),
              ),
            );
          },
          borderRadius: BorderRadius.circular(AppDimensions.radiusLarge),

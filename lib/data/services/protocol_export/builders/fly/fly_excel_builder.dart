...
class FlyExcelBuilder extends BaseExcelBuilder {
  ...
  int buildTableContent(
    ...
    throw UnimplementedError(
      'Excel экспорт для нахлыстовой рыбалки пока не реализован.\n'
          'Тип протокола: $type',
    );
  }
